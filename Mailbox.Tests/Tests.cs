...
namespace Mailbox.Tests
{
     ...
     public class Tests
    {
        ...
        public void TestSaveAndLoad()
        {
            ...
            using (var dataLoader = new DataLoader(File.Open(FileName, FileMode.Create, FileAccess.ReadWrite)))
            {
            ...
            //trying
            using var dataLoad = new DataLoader(File.Open(FileName, FileMode.OpenOrCreate, FileAccess.ReadWrite));
